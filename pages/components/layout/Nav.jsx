  ...
  return (
    <div className="navbar">
      <ul className="pageList" style={{listStyle: "none", display: "inline-flex"}}>
        <li className="item"><a href="/index" style={{display: "inline-flex"}}><Image src="./DarkLogo.png" style={{width: "40px", height: "30px", paddingRight: "10px"}} className="logo"/> Home</a></li>
