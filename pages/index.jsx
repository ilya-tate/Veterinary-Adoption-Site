...
export default function Home() {
  return (
    <div className="homeDiv" style={{ overflowX: "hidden", background: "#00FFFF" }}>
      <Nav />
      <div
        className="main"
        style={{
      ...
      <div className="events"
        ...
        <div className="event1 event" style={{border: "2px solid black", width: "25%"}}>
          <img src={image} className="eventImage"/>
          <div className="header" style={{display: "inline-flex", width: "100%"}}><h1 style={{marginLeft: "10%", fontSize: "30px", position: "relative", top: "-55px"}}><a className="eventItemLarge"><Icon name="map marker alternate" /></a> <a className="eventItemLarge">West Mec Central</a></h1></div>
      ...
      <div style={{position: "relative", bottom: "0"}}>
        <Divider style={{backgroundColor: "gray", color: "gray", height: "7px", paddingBottom: "0", marginBottom: "0"}}/>
